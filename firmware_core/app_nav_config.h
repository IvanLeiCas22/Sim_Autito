...
#define APP_NAV_PIVOT_PREP_SPEED_PERCENT_MIN 10U
#define APP_NAV_PIVOT_PREP_SPEED_PERCENT_MAX 100U
#define APP_NAV_DEFAULT_PIVOT_PREP_SPEED_PERCENT 80U
...
static inline AppNavConfig App_Nav_DefaultConfig(void)
{
    ...
    cfg.pivot_prep_speed_percent = APP_NAV_DEFAULT_PIVOT_PREP_SPEED_PERCENT;
